...
output$ihk_item <- renderMenu({
  req(data_uploaded())
  menuItem("IHK", icon = icon("chart-line"), startExpanded = TRUE,
           menuSubItem("IHK Bulanan", tabName = "ihk_bulanan"),
           menuSubItem("IHK Triwulanan", tabName = "ihk_triwulanan"))
})
